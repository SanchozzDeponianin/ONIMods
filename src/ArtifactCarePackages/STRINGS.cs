namespace ArtifactCarePackages
{
    public class STRINGS
    {
        public class OPTIONS
        {
            ...
            {
                public static LocString NAME = "Cycles before the Tier0 artifact will be available";
            }
            public class CYCLESUNTILTIERNEXT
            {
                public static LocString NAME = "Cycles before the each next Tier artifact will be available";
            }
            public class RANDOMARTIFACTDROPTABLESLOTS
            {
